...
| Feature          | **SLA** (Agreement)             | **SLO** (Objective)          | **SLI** (Indicator)               |
| :--------------- | :------------------------------ | :--------------------------- | :-------------------------------- |
| **What is it?**  | A contractual commitment.       | A target for that metric.    | A specific metric or measurement. |
| **Example**      | 99.9% uptime promise.           | 99.9% uptime target.         | Uptime percentage.                |
| **Audience**     | Customers/Business.             | Internal Teams.              | Engineers/Operations.             |
| **Legal Status** | **Legally binding**.            | No legal binding.            | No legal binding.                 |
| **Consequence**  | Payouts, credits, or penalties. | Internal alerts/fixing work. | None; it is a data point.         |